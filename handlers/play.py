...
async def play(_, message: Message):
    ...
    response = await message.reply_text("**Please Wait, Processing Your Song 🥰...**")
...
async def nplay(_, message: Message):
    ...
    lel = await message.reply_text("**Please Wait, Processing Your Song 🥰...**")

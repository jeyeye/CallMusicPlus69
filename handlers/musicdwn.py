...
@Client.on_message(filters.command(['aFASAGDyts', f'yts@{BOT_USERNAME}']))
...
@Client.on_message(filters.command(["ssdagbaavn", f"saavn@{BOT_USERNAME}"]) & ~filters.edited)
@capture_err
...
@Client.on_message(filters.command(["dasgdgseezer", f"deezer@{BOT_USERNAME}"]) & ~filters.edited)
@capture_err
...
@Client.on_message(filters.command(["asadgsdlyrics", f"lyrics@{BOT_USERNAME}"]))
...
@Client.on_message(filters.command(["agasdytvid", f"ytvid@{BOT_USERNAME}"]))
